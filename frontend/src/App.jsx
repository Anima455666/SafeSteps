      ...
      <div className="flex flex-col" style={{ minHeight: '100vh' }}>
          ...
          <div className="container mx-auto flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                ...
                />
                <Search className="absolute right-3 top-2.5 text-gray-500 w-4 h-4 md:w-5 md:h-5" />
              </div>
              <Link
                to="/premium"
              ...
              >
                <span className="text-xl">⚡</span> {/* Larger lightning emoji */}
                Premium
              </Link>
            </div>
          </div>
        ...
        <section className="bg-gradient-to-r from-[#6a1b9a] to-[#e61f93] text-white py-12 md:py-16 flex-grow flex items-center">
          <div className="container mx-auto text-center px-4">
            ...
            {/* Adjusted paragraph size (smaller) */}
